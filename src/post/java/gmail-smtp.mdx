...
## 앱 비밀번호 설정
- 앱 비밀번호 설정
![app-password-setting #1](/posts/java/gmail-smtp/1.png)
- 앱 이름 설정
![app-password-setting #2](/posts/java/gmail-smtp/2.png)
- 앱 비밀번호 생성
![app-password-setting #3](/posts/java/gmail-smtp/3.png)

## 설정
- Gmail에 들어가서 설정 -> 모든 설정 보기 클릭
![gmail-setting #1](/posts/java/gmail-smtp/4.png)
- 계정 및 가져오기 에서 다른 이메일 주소 추가 클릭
![gmail-setting #2](/posts/java/gmail-smtp/5.png)
- 원하는 이름 및 이메일 주소 입력
![gmail-setting #3](/posts/java/gmail-smtp/6.png)
- 일반 Gmail이 아닌, 학교 및 직장 내 게정이라면 아래처럼 이런 창이 뜰 것이다.
![gmail-setting #4](/posts/java/gmail-smtp/7.png)
...
![gmail-setting #5](/posts/java/gmail-smtp/8.png)
- 이제 전송된 메일을 확인하여 인증을 진행하면 완료
![gmail-setting #6](/posts/java/gmail-smtp/9.png)
- 설정 창에서 확인해보면 잘 등록된 것을 확인할 수 있다.
![gmail-setting #7](/posts/java/gmail-smtp/10.png)
